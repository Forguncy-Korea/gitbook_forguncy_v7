...
저장 프로시저는 특정 기능을 완료하기 위한 SQL 문 집합으로, 컴파일되어 데이터베이스에 저장되며 사용자는 저장 프로시저의 이름을 지정하고 매개 변수를 지정하여 실행을 호출할 수 있습니다.

포건시는 서버 측에서 저장 프로시저를 사용하여 명령을 호출할 수 있도록 지원합니다.

## 저장 프로시저 호출 하기&#x20;

다음은 SQL Server를 호출하는 저장 프로시저를 예로 들어 서버 쪽 명령의 저장 프로시저를 사용하여 명령을 호출하는 방법을 보여 줍니다.

![](https://help.grapecity.com.cn/download/thumbnails/72358307/%E6%AD%A5%E9%AA%A41.png?version=1\&modificationDate=1648092617000\&api=v2)  다음 그림과 같이 저장 프로시저가 이미 있는 Mysql 데이터베이스에 연결합니다.

![](<../../../.gitbook/assets/image (1019).png>)

![](https://help.grapecity.com.cn/download/thumbnails/72358307/%E6%AD%A5%E9%AA%A42.png?version=1\&modificationDate=1648092617000\&api=v2)  프로젝트 탐색기에서 서버단 명령 탭을 마우스 오른쪽 버튼으로 클릭하고 "서버단 명령 생성하기"를 선택하면 서버 명령 편집 대화 상자가 나타나 서버 명령의 일반 설정을 편집할 수 있습니다. 서버 명령의 이름을 "저장 프로시저 호출"로 설정합니다.

![](https://help.grapecity.com.cn/download/thumbnails/72358307/%E6%AD%A5%E9%AA%A43.png?version=1\&modificationDate=1648092617000\&api=v2)  파라미터를 편집합니다. 다음 두 파라미터를 추가합니다.

![](<../../../.gitbook/assets/image (1054).png>)



## ![](https://help.grapecity.com.cn/download/thumbnails/72358307/decoration.png?version=1\&modificationDate=1648092616000\&api=v2)**1. 설명**![](https://help.grapecity.com.cn/download/attachments/72358307/line2.png?version=1\&modificationDate=1648092617000\&api=v2) <a href="#id-cun-chu-guo-cheng-tiao-yong-1.-miao-shu" id="id-cun-chu-guo-cheng-tiao-yong-1.-miao-shu"></a>
...
## ![](https://help.grapecity.com.cn/download/thumbnails/72358307/decoration.png?version=1\&modificationDate=1648092616000\&api=v2)**2. 저장 프로시저 호출 명령**![](https://help.grapecity.com.cn/download/attachments/72358307/line2.png?version=1\&modificationDate=1648092617000\&api=v2) <a href="#id-cun-chu-guo-cheng-tiao-yong-2.-cun-chu-guo-cheng-tiao-yong-ming-ling" id="id-cun-chu-guo-cheng-tiao-yong-2.-cun-chu-guo-cheng-tiao-yong-ming-ling"></a>
