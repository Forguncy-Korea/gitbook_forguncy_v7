...
4. 확인을 클릭하여 OData 생성기를 닫습니다. 이 시점에서 얻은 처음 세 행의 데이터는 데이터 집합이므로 Excel의 배열 수식이 필요합니다.
...
5. (선택 사항) 셀 서식을 지정합니다. 두 번째 열은 날짜 형식 필드이며 날짜 형식으로 설정해야 합니다.&#x20;
6. &#x20;실행 후 브라우저에서 완료된 처음 주문에 대한 레코드를 볼 수 있습니다.
