...
![](<../../../.gitbook/assets/image (12).png>): 현재 작업(task) 위에  작업 추가

![](<../../../.gitbook/assets/image (14).png>): 현재 작업(task) 아래에 작업 추가&#x20;

![](<../../../.gitbook/assets/image (10).png>): 현재 작업 수준(Level) 줄이기 ,가장 높은 작업수준(Level)은 단일노드 (Leaf node)

![](<../../../.gitbook/assets/image (72).png>): 현재 작업 수준 올리기

![](<../../../.gitbook/assets/image (73).png>): 같은 수준(Level)에서 현재 작업을 위로 이동&#x20;

![](<../../../.gitbook/assets/image (28).png>): 같은 수준(Level)에서 현재 작업을 아래로 이동&#x20;

![](<../../../.gitbook/assets/image (58).png>):  현재 작업 삭제&#x20;

![](<../../../.gitbook/assets/image (61).png>) :  현재 작업의 서브작업 확장&#x20;

![](<../../../.gitbook/assets/image (22).png>):  현재 작업의 서브작업 축소&#x20;

![](<../../../.gitbook/assets/image (66).png>) : 시간 단위(월 → 주)를 줄이고 오른쪽 보기의 크기를 늘림&#x20;

![](<../../../.gitbook/assets/image (3).png>) : 시간 단위(월 → 주)를 늘리고 오른쪽 보기의 크기를 줄임&#x20;

![](<../../../.gitbook/assets/image (1005).png>):  오른쪽 그래프 화면으로 전체보기&#x20;

![](<../../../.gitbook/assets/image (35).png>): 왼쪽 편집 화면과 오른쪽 그래프 화면으로 나누기&#x20;

![](<../../../.gitbook/assets/image (31).png>): 왼쪽 편집 화면으로 전체보기&#x20;

![](<../../../.gitbook/assets/image (70).png>): 크리티컬 패스(critical path) 하이라이트

![](<../../../.gitbook/assets/image (785).png>): 작업 상태 색상 표시/표시안하기&#x20;

![](<../../../.gitbook/assets/image (796).png>): 오른쪽 그래프의 표시 방식 전환: 계획만 표시, 계획 표시, 실제 표시.

&#x20;        (actualStart 및 actualEnd 컬럼을 설정하지 않으면 이 버튼이 나타나지 않습니다.)

![](<../../../.gitbook/assets/image (810).png>): 저장 버튼, 테이블에 데이터를 저장
